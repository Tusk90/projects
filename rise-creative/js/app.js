(() => {
    ...
    function initSliders() {
        if (document.querySelector(".elegant__slider")) new swiper_core_Swiper(".elegant__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".elegant__arrow--left",
                nextEl: ".elegant__arrow--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".words__slider")) new swiper_core_Swiper(".words__slider", {
